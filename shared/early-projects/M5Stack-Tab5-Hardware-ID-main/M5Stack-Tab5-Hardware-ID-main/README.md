...
This project runs on the Tab5 microcontroller and prints various hardware info about the connected dev board to the screen:
- Dev Board Type
- LCD Panel Type
- LCD Resolution
- LCD Max Touch Points
- MCU Info
- Flash Memory
- PSRAM Memory
- A scan of the internal and external I2C buses

## Hardware

Microcontroller:  M5Stack Tab5 (ESP32-P4NRW32@RISC-V 32-bit Dual-core 360MHz + LP Single-core 40MHz)
Display:  5" (1280 x 720) IPS TFT LCD
...
#### LCD ILI9881C (old style) / ST7123 (new style)
...
GT911 old style (0x14) / ST7123new style (0x55)
G31 - SDA
G32 - SCL
G23 - TP_INT
E1.P5 - TP_RST
...
Referenced as Wire1() in Arduino.
