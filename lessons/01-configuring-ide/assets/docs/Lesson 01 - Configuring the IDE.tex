...
We now have a local folder containing the project files for this Microcontroller
Training. It is located The lessons, including this one, are located in the \textbf{lessons} 
folder. Browse into the lesson \textbf{02-hello-world}.
\vspace{3mm}
\begin{figure}[H]
    \centering
...
\end{figure}
\vspace{3mm}
\textbf{Open Lesson 02} and look at the file structure. At the top level of that folder, we see:
\begin{itemize}
    \item The \textbf{assets} folder contains any files we might need, like schematics, datasheets, etc. 
    \item The \textbf{code} folder contains any program and project files associated with the lesson.
    \item The \textbf{Lesson 02 - Configuring the IDE.pdf} file contains the lesson information.
    \item The README.md file which contains any lesson-specific notes from the author. 
\end{itemize}
\newpage
